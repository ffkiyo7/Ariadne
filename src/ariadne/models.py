...
class TurnKind(str, Enum):
    """The durable executor selected for a queued turn."""
...
class Turn:
    ...
    execution_kind: TurnKind
    success_session_status: SessionStatus | None
    state: TurnState
    attempt: int
    unit_name: str | None
    started_at: str | None
...
class PipelineRun:
    ...
    task_path: Path | None
    task_hash: str | None
    task_turn_id: str | None
    task_baseline_json: str | None
    task_start_head_sha: str | None
    head_sha: str | None
    review_round: int
    pr_number: int | None
    ci_state: str | None
