...
# Keep the legacy prefix readable during a controlled r9 cutover, while all
# new Ariadne turns receive the product name.
_UNIT_RE = re.compile(r"^(?:ariadne|dev-pipeline)-turn-S-[0-9]{4}-T-[0-9]{4}$")
